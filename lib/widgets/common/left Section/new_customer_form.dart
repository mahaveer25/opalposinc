...
class AddNewCustomer extends StatefulWidget {
  ...
  @override
  State<AddNewCustomer> createState() => _CustomDialogState();
}

class _CustomDialogState extends State<AddNewCustomer> {
                            ...
                            child: DropdownButton2<String>(
                              ...
                              onChanged: (value) {
                                setState(() {
                                  selectedValue = value;
                                  updateSelectedIndex(
                                      customertype.indexOf(value!));
                                  _contactTypeController.text = value;
                                  print(_contactTypeController.text =
                                      selectedValue!);
                                });
                              },
                  ...
                  Row(
                    children: [
                      ...
                      Visibility(
                        ...
                        child: Expanded(
                          child: CustomInputField(
                              controller: _payTermTypeController,
                              labelText: 'Pay Term Type',
                              hintText: 'Enter Pay Term Type',
                              toHide: false),
                        ),
                      ),
                    ],
...
class CustomDateInputField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: 76, // Set the desired height for both fields
      child: Padding(
