...
import 'package:opalsystem/widgets/CustomWidgets/custom_text_widgets.dart'; // Assuming this is your custom text widget file
...
class _ItemsNewCloverState extends State<ItemsNewClover> {
  final List<Map<String, String>> items = [
    {"name": "Gold Fume Wp", "code": "A123", "sku": "SKU123", "price": "\$10.00"},
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Row(
                            ...
                            children:List.generate(headings.length, (headingIndex)=>  SizedBox(
                                width:MyUtility.fixedWidthCloverNewDesign,
                                child: Text(items[index][headings[headingIndex]]??"", )),)
              ...
              children: [
                ...
                Expanded(
                  child: CustomElevatedButton(
                    ...
                    onPressed:() {
                      context.read<InventoryBloc>().add(MenuSelectionEvent(selectedMenu: MyUtility.addItem));
                ...
                Expanded(
                  child: CustomElevatedButton(
                    ...
                    text: ' Add item with variants',onPressed:() {
