...
import 'package:opalsystem/CloverDesign/Dashboard%20Pages/widgets/category_dialog.dart';
...
class _CategoriesNewCloverState extends State<CategoriesNewClover> {
   ...
   final List<Map<String, String>> categories = [
     ...
     {"Category": "Cigerattes ", "Category code": "Gold Fumes", "Description": "7"},
     {"Category": "Dollar ", "Category code": "Pencil, ", "Description": "7"},
     {"Category": "Energy Drink", "Category code": "Red Bull", "Description": "10"},
     {"Category": "Snacks ", "Category code": "Chips, Chocolate Bar", "Description": "15"},
        ...
        Column(
          children: [
            Row(
              ...
              children: [
                NavBar(fixedWidth:  MyUtility.fixedWidthCloverNewDesign,headings: headings,),
                SizedBox(
                        ...
                        Expanded(
                          child: Row(
                                ...
                                children: List.generate(
                                  headings.length,
                                    ...
                                    return SizedBox(
                                      width: MyUtility.fixedWidthCloverNewDesign,
                                      child: Text(
                                        categories[index][headings[headingIndex]] ?? "",
                            ...
                            child: Row(
                              ...
                              children: [
                            IconButton(
                            icon:  Icon(Icons.edit, color: Constant.colorPurple),
                                 onPressed: () {
                                   showDialog(
                                     context: context,
                                ...
                                IconButton(
                                  icon:  Icon(Icons.delete, color:Constant.colorRed),
                                  onPressed: () {
                                    setState(() {
                                      categories.removeAt(index);
                                    });
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(content: Text("Deleted ${categories[index]['Name']}")),
                                    );
                                  },
                                ),
                              ],
