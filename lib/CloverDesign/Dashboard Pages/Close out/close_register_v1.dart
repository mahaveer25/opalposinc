...
class _CloseRegisterV1State extends State<CloseRegisterV1> with PrintPDF {
  ...
  Future<void> _closeCashRegister() async {
    ...
    if (response['success'] == true) {
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const OpenRegisterv1()),);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:PreferredSize(
          ...
          child: CommonAppBarV1(imagePath:    Myassets.closeOut, title: "Closeout",)),
  ...
  builder: (context, isMobile) {
    if (registerDetails!=null) {
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: DataTable(
                                columnSpacing: isMobile
                                    ...
                                    : MediaQuery.of(context).size.width / 3.97,
      ...
      child: SizedBox(
        width: 24,
        height: 24,
        child: CircularProgressIndicator(color: Constant.colorPurple,),
      ),
    );
    }
  },
