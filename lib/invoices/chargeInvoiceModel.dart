class ChargeInvoiceModel {
  ...
  static ChargeInvoiceModel fromJson(Map<String, Object?> json) {
    return ChargeInvoiceModel(
        ...
        footerText:
            json['footer_text'] == null ? null : json['footer_text'] as String,
        poweredBy:
            json['powered_by'] == null ? null : json['powered_by'] as String);
  }
...
poweredBy:$poweredBy
  ...
  bool operator ==(Object other) {
    return other is ChargeInvoiceModel &&
...
class Response {
  ...
  final dynamic clerkId;
  final dynamic clerkName;
  final dynamic clerkLabel;
  final dynamic additionalKeyOne;
  final dynamic additionalKeyTwo;
  final dynamic additionalValueOne;
  final dynamic additionalValueTwo;
  ...
  Response copyWith(
      ...
      dynamic clerkName,
      dynamic clerkLabel,
      dynamic additionalKeyOne,
      dynamic additionalKeyTwo,
      dynamic additionalValueOne,
      dynamic additionalValueTwo,
      String? approvalCode,
      String? rrn,
      String? txnid,
      int? tranNo,
  ...
  static Response fromJson(Map<String, Object?> json) {
    return Response(
        ...
        additionalInfo: json['additional_info'] as dynamic,
        clerkId: json['clerk_id'] as dynamic,
        clerkName: json['clerk_name'] as dynamic,
        clerkLabel: json['clerk_label'] as dynamic,
        additionalKeyOne: json['additionalKeyOne'] as dynamic,
        additionalKeyTwo: json['additionalKeyTwo'] as dynamic,
        additionalValueOne: json['additionalValueOne'] as dynamic,
        additionalValueTwo: json['additionalValueTwo'] as dynamic,
        ...
        cardType: json['card_type'] as dynamic,
